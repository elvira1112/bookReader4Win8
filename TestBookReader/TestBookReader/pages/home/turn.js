...
(function (f) {
    ...
    function O(a, b, c, d, e) {
        ...
        if ("-webkit-" == v) {
            ...
            a.css({"background-image": "-webkit-gradient(linear, " +
                b.x + "% " + b.y + "%," + c.x + "% " + c.y + "%, " + f.join(",") + " )"})
        } else {
            var b = {x: b.x / 100 * a.width(), y: b.y / 100 * a.height()}, c = {x: c.x / 100 * a.width(), y: c.y / 100 * a.height()}, g = c.x - b.x;
            h = c.y - b.y;
    ...
    var y, T, v = "", J = Math.PI, K = J / 2, t = "ontouchstart"in
        ...
        var c;
        b = 0;
        var e = this.children(), a = f.extend({width: this.width(), height: this.height(), direction: this.attr("dir") || this.css("direction") || "ltr"}, W, a);
        this.data() = { opts: a, pageObjs: {}, pages: {}, pageWrap: {}, pageZoom: {}, pagePlace: {}, pageMv: [], zoom: 1, totalPages: a.pages || 0, eventHandlers: { touchStart: f.proxy(g._touchStart, this), touchMove: f.proxy(g._touchMove, this), touchEnd: f.proxy(g._touchEnd, this), start: f.proxy(g._eventStart, this) } };
        var b = this.data();
        ...
        if (c)if (g._necessPage.call(this, a)) {
            if (!b.pageWrap[a]) {
                b.pageWrap[a] = f("<div/>", {"class": "page-wrapper", page: a, css: {position: "absolute",
                    overflow: "hidden"}});
        ...
        var b= {display:undefined,pageObjs:[]};
        b = f.extend(b, this.data());
        var c = b.display;
        ...
        f.extend(this.data(),{direction:a});
        this.data()('done') && this.turn("size", f(this).width(), f(this).height());
        return this
    }, animating: function () {
        ...
        var b = {disabled:false,destroying:false,totalPages:0,page:undefined,done:false};f.extend(b,this.data());
        ...
        var a = {pages:[]};a = f.extend(a,this.data());var b;
        ...
        if (!this.turn("animating"))switch (d) {
            case 1:
                b.pageWrap[a].css({zIndex: b.totalPages,
                    display: ""});
                break;
            case 2:
        ...
        switch (b.effect) {
            case "hard":
                ...
                break;
            case "sheet":
                a && (a = Math.round(Math.sqrt(Math.pow(d, 2) + Math.pow(e, 2))), b.wrapper.css({width: a, height: a}), b.fwrapper.css({width: a, height: a}).children(":first-child").css({width: d,
                    height: e}), b.fpage.css({width: d, height: e}), c.opts.gradients && b.ashadow.css({width: d, height: e}), i._backGradient.call(this) && b.bshadow.css({width: d, height: e})), b.parent.is(":visible") && (c = C(b.parent[0]), b.fwrapper.css({top: c.top, left: c.left}), c = C(b.opts.turn[0]), b.fparent.css({top: -c.top, left: -c.left})), this.flip("z", b.opts["z-index"])
        }
        ...
        switch (b.effect) {
            ...
            case "sheet":
                ...
                f = function (a, d, f, g) {
                    var k = ["0", "auto"], m = (e - Q) * f[0] / 100, l = (h - Q) * f[1] / 100, d = {left: k[d[0]], top: k[d[1]], right: k[d[2]], bottom: k[d[3]]}, k = {}, n = 90 != g && -90 != g ? B ? -1 : 1 : 0, r = f[0] + "% " + f[1] + "%";
        ...
        if (c) {
            ...
            if (b) {
                ...
                this.animatef({from: [d.x, d.y], to: [a.x, a.y], duration: 500, frame: function (b) {
                    a.x = Math.round(b[0]);
                    a.y = Math.round(b[1]);
                    i._fold.call(g, a)
                }})
    ...
    f.extend(f.fn, {flip: function () {
        ...
        if (a) {
            ...
            b.effect = f.extend({stop: function () {
                e =
                    false
    ...
    f.cssTransitionEnd = function () {
        var a, b = document.createElement("fakeelement"), c = {transition: "transitionend", OTransition: "oTransitionEnd", MSTransition: "transitionend", MozTransition: "transitionend", WebkitTransition: "webkitTransitionEnd"};
